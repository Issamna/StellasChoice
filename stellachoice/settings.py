"""
Django settings for stellachoice project.
...
SECRET_KEY = 'w4hvjmlg04pep4r2j6=x=k%px7%qrd@13b!xsaok&_41%*q-h4'
...
ROOT_URLCONF = 'stellachoice.urls'
...
WSGI_APPLICATION = 'stellachoice.wsgi.application'
